      ...
      {showRecenter && (
        ...
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5">
            <circle cx="12" cy="12" r="7" fill="none" stroke="#2f5fe0" strokeWidth="2" />
            <circle cx="12" cy="12" r="2.6" fill="#2f5fe0" />
            <line x1="12" y1="0.5" x2="12" y2="4" stroke="#2f5fe0" strokeWidth="2" />
            <line x1="12" y1="20" x2="12" y2="23.5" stroke="#2f5fe0" strokeWidth="2" />
            <line x1="0.5" y1="12" x2="4" y2="12" stroke="#2f5fe0" strokeWidth="2" />
            <line x1="20" y1="12" x2="23.5" y2="12" stroke="#2f5fe0" strokeWidth="2" />
          </svg>
        </button>
      )}
