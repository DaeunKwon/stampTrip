...
/** 이미 방문 인증한 관광지 마커용 회색 체크 핀 이미지를 생성합니다. */
export function createStampedMarkerImage(maps) {
  return new maps.MarkerImage(svgToDataUri(STAMPED_PIN_SVG), new maps.Size(26, 34), {
